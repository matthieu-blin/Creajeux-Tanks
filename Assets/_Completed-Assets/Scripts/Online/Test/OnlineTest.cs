...
public class OnlineTest : OnlineBehavior
{
    ...
    {
        GameObject obj = OnlineObject.Instantiate(prefab, new Vector3(0,0,175), Quaternion.identity);
   ...
   public void TestSpawn2()
    ...
    void TestCMD()
    {
        text.text = ("CMD called on object " + Uid);
    }
    [RPC]
    void TestRPC()
    {

        text.text = ("RPC called on object " + Uid);
    }
}
